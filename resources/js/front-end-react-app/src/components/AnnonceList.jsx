...
import { AnnonceListSkeleton } from '../ui/Skeleton';

function AnnonceList({ announcements }) {
  const { props } = usePage();
  const list = announcements || props.announcements || [];
              ...
              >
                ...
                <div className="relative bg-white/80 backdrop-blur-xl rounded-3xl p-6 shadow-xl border border-white/40 transition-all duration-500 hover:shadow-2xl hover:-translate-y-1 hover:bg-white/90">
                  ...
                  <div 
                    ...
                    style={{
                      background: 'linear-gradient(180deg, #003366 0%, #00AEEF 100%)',
                  ...
                  <div className="absolute top-4 right-4 z-10">
                    <span 
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-gray-100/80 backdrop-blur-sm text-gray-700 rounded-full text-xs font-medium shadow-sm"
                      style={{ fontFamily: 'Inter, system-ui, sans-serif' }}
                    >
                  ...
                  <div className="ml-3 pr-16">
                    {/* Title */}
                    <h3 
                      className="text-xl font-bold text-[#003366] mb-4 group-hover:text-[#00AEEF] transition-colors duration-300 pr-8"
                      style={{ 
                        lineHeight: '1.4',
                  ...
                  {annonce.attachment && (
                    <motion.button
                      ...
                      whileTap={{ scale: 0.95 }}
                      className="absolute bottom-6 right-6 w-14 h-14 bg-[#00AEEF] text-white rounded-full shadow-lg flex items-center justify-center transition-all duration-300 hover:shadow-2xl z-10"
                      style={{
                        boxShadow: hoveredCard === annonce.id 
                          ? '0 0 20px rgba(0, 174, 239, 0.6), 0 4px 12px rgba(0, 174, 239, 0.4)' 
